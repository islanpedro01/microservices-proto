...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\rdelivery_days\x18\x01 \x01(\x05R\fdeliveryDays2a\n" +
	"\bShipping\x12U\n" +
	"\x0eCreateShipping\x12\x1f.shipping.CreateShippingRequest\x1a .shipping.CreateShippingResponse\"\x00B=Z;github.com/islanpedro01/microservices-proto/golang/shippingb\x06proto3"
...
var file_shipping_shipping_proto_depIdxs = []int32{
	...
	1, // 1: shipping.Shipping.CreateShipping:input_type -> shipping.CreateShippingRequest
	2, // 2: shipping.Shipping.CreateShipping:output_type -> shipping.CreateShippingResponse
